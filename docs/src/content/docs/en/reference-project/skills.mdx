...
Skill management mode is determined by its storage root. Skills in writable DATA storage are runtime-manageable, while firmware-baked SYSTEM skills are read-only.
